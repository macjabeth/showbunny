...
!((e, t, n, r) => {
  ...
  function d(e) {
    return e.replace(/([A-Z])/g, (e, t) => '-' + t.toLowerCase()).replace(/^ms-/, '-ms-');
  }
  function p(e, n) {
    var o = e.length;
  ...
  function m(e) {
    return e.replace(/([a-z])-([a-z])/g, (e, t, n) => t + n.toUpperCase()).replace(/^-/, '');
  }
  function h(e, t, n, i) {
    function s() {
  ...
  !(() => {
    ...
    k =
      o(e, 'undefined') || o(e.call, 'undefined')
        ? (e, t) => t in e && o(e.constructor.prototype[t], 'undefined')
        : (t, n) => e.call(t, n);
  })(),
    (C._l = {}),
    (C.on = function (e, t) {
  ...
  var B = (() => {
    ...
    return e
      ...
      : (e) => {
          var t = !1;
          return (
            u('@media ' + e + ' { #modernizr { position: absolute; } }', (e) => {
  ...
  Modernizr._q.unshift(() => {
    ...
    (C.testAllProps = g),
    (C.testAllProps = y);
  (C.testProp = (e, t, n) => h([e], r, t, n)), (C.testStyles = u);
  ...
  Modernizr.addTest('postmessage', new Boolean('postMessage' in t)),
    ...
    Modernizr.addTest('webgl', () => 'WebGLRenderingContext' in t);
  var M = !1;
  try {
